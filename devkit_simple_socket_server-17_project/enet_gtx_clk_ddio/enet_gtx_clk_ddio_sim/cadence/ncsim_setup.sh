...
# ACDS 20.1 711 linux 2021.09.19.07:38:30
...
# ----------------------------------------
# If enet_gtx_clk_ddio is one of several IP cores in your
...
TOP_LEVEL_NAME="enet_gtx_clk_ddio"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/enet_gtx_clk_ddio/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_gpio_lite/altera_gpio_lite.sv" -work enet_gtx_clk_ddio -cdslib ./cds_libs/enet_gtx_clk_ddio.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/enet_gtx_clk_ddio.v"                                                                                      
fi
